...
var CoreRemoteMongoCollectionImpl = (function () {
    ...
    CoreRemoteMongoCollectionImpl.prototype.insertOne = function (value) {
        ...
        return this.service.callFunctionInternal("insertOne", [args], ResultDecoders.remoteInsertOneResultDecoder);
    };
    CoreRemoteMongoCollectionImpl.prototype.insertMany = function (docs) {
        ...
        return this.service.callFunctionInternal("insertMany", [args], ResultDecoders.remoteInsertManyResultDecoder);
    };
    ...
    CoreRemoteMongoCollectionImpl.prototype.executeDelete = function (query, multi) {
        var args = __assign({}, this.baseOperationArgs);
        args.query = query;
        return this.service.callFunctionInternal(multi ? "deleteMany" : "deleteOne", [args], ResultDecoders.remoteDeleteResultDecoder);
    };
    CoreRemoteMongoCollectionImpl.prototype.executeUpdate = function (query, update, options, multi) {
        ...
        return this.service.callFunctionInternal(multi ? "updateMany" : "updateOne", [args], ResultDecoders.remoteUpdateResultDecoder);
    };
