...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "mongodb-stitch-core-sdk", "../../services/internal/StitchServiceImpl", "../auth/internal/StitchAuthImpl", "../auth/internal/StitchBrowserAppRoutes"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var mongodb_stitch_core_sdk_1 = require("mongodb-stitch-core-sdk");
    var StitchServiceImpl_1 = __importDefault(require("../../services/internal/StitchServiceImpl"));
    ...
    var StitchAppClientImpl = (function () {
        ...
        StitchAppClientImpl.prototype.getServiceClient = function (factory, serviceName) {
            if (isServiceClientFactory(factory)) {
                return factory.getClient(new StitchServiceImpl_1.default(this.auth, this.routes.serviceRoutes, ""), this.info);
            }
            else {
                return factory.getNamedClient(new StitchServiceImpl_1.default(this.auth, this.routes.serviceRoutes, serviceName), this.info);
            }
        };
